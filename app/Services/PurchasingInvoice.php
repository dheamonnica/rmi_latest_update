...
class PurchasingInvoice extends FPDF
{
    ...
    public function setManufactureNumber($manufacture_number)
    {
        $this->manufacture_number = $manufacture_number;
    }

    public function setPurchasingInvoiceNumber($purchasing_invoice_number)
    {
        $this->purchasing_invoice_number = $purchasing_invoice_number;
    }
    ...
    public function Header()
    {
        ...
        if (!isset($this->productsEnded)) {
            ...
            $this->Cell(
                ...
                10,
                $this->str_iconv(trans('invoice.product'), true),
                0,
                0,
                'L',
                0
