...
class CheckoutController extends Controller
{
    ...
    public function paymentOptions(Cart $cart)
    {
        ...
        foreach ($activePaymentMethods as $payment) {
            ...
            // Additional details for the payment method
            $additional_details = get_payment_config_info($payment->code, $shop_config);
            if (isset($additional_details['config']['additional_details'])) {
                $payment->additional_details = $additional_details['config']['additional_details'];
            } else {
                $payment->additional_details = $additional_details['msg'];
            }
