...
class PageController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function create(FlatformUserAccessRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function trash(FlatformUserAccessRequest $request, $id)
    {
        $this->page->trash($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function restore(FlatformUserAccessRequest $request, $id)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(FlatformUserAccessRequest $request, $id)
    {
