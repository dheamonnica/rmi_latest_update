...
class Statistics
{
    ...
    {
        return Order::query()->whereDate('created_at', \Carbon\Carbon::today())->count();
    }

    public static function yesterday_order_count()
    {
        return Order::mine()->withTrashed()->whereDate('created_at', \Carbon\Carbon::yesterday())->count();
    }

    public static function yesterday_all_order_count()
    {
        return Order::query()->whereDate('created_at', \Carbon\Carbon::yesterday())->count();
    }
