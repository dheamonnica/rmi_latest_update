...
@if ($linked_items->count())
  <section>
    <div class="container md-100">
      <div class="row">
        <div class="col-md-12">
          <div class="frequently-bought-section pb-3">
            <div class="section-title pt-0 mb-0">
              <h4>@lang('theme.section_headings.frequently_bought_together')</h4>
            </div>

            <div class="sidebar-product-list row flex-column flex-sm-row justify-content-center">
...
<section class="single-product-desc">
  <div class="container mt-5 md-100">
    <div class="row">
      <div class="col-md-12" id="product-desc-section">
        <div role="tabpanel">
