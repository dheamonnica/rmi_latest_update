...
<script type="text/javascript">
  ...
  (function($, window, document) {
    ...
    let downloadable = '{{ $item->product->downloadable }}';
    let handlingCost = getFromPHPHelper('getHandelingCostOf', shop_id);
    let unitPrice = '{{ get_formated_price_value($item->current_sale_price()) }}';
    ...
    function setKeyFeatures(item) {
      $('.key-feature-list').html(item.key_features);
    }
