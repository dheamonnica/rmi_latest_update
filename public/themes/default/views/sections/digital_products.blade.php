          ...
          <div class="neckbands-header">
            <div class="sell-header">
              <div class="sell-header-title">
                <h2>{{ trans('theme.digital_products') }} <i class="fas fa-cloud-download-alt"></i> </h2>
              </div>
              ...
              <div class="best-deal-arrow">
                <ul>
                  <li><button class="left-arrow slider-arrow slick-arrow digital-left"><i class="fal fa-chevron-left"></i></button></li>
                  <li><button class="right-arrow slider-arrow slick-arrow digital-right"><i class="fal fa-chevron-right"></i></button></li>
                </ul>
              </div>
            </div>
