<div class="row">
    <div class="col-md-4 nopadding-right">
        <div class="form-group">
            ...
            {!! Form::text('name', null, [
                'class' => 'form-control',
                'placeholder' => trans('app.placeholder.full_name'),
                'required',
            ]) !!}
    ...
    <div class="col-md-4 nopadding-left nopadding-right">
        <div class="form-group">
            ...
            {!! Form::select('active', ['1' => trans('app.active'), '0' => trans('app.inactive')], null, [
    ...
    <div class="col-md-4 nopadding-left">
        <div class="form-group">
            ...
            {!! Form::select(
                'sex',
                ['app.male' => trans('app.male'), 'app.female' => trans('app.female'), 'app.other' => trans('app.other')],
                null,
                ['class' => 'form-control select2-normal', 'placeholder' => trans('app.placeholder.sex')],
            ) !!}
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6 nopadding-left">
        <div class="form-group">
            {!! Form::label('office_location_id', trans('app.form.select_office_location') . '*') !!}
            {!! Form::select('office_location_id', ['' => 'Select'] + $merchants, null, [
                'class' => 'form-control select2-normal',
                'required',
            ]) !!}
        </div>
...
<div class="row">
    <div class="col-md-6 nopadding-right">
        <div class="form-group">
            ...
            {!! Form::text('nice_name', null, [
                'class' => 'form-control',
                'placeholder' => trans('app.placeholder.nice_name'),
            ]) !!}
        </div>
    </div>
    <div class="col-md-6 nopadding-left">
        <div class="form-group">
            ...
            {!! Form::email('email', null, [
                'class' => 'form-control',
                'placeholder' => trans('app.placeholder.valid_email'),
                'required',
            ]) !!}
            <div class="help-block with-errors"></div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 nopadding-right">
                {!! Form::password('password', [
                    'class' => 'form-control',
                    'id' => 'password',
                    'placeholder' => trans('app.placeholder.password'),
                    'data-minlength' => '6',
                    'required',
                ]) !!}
                <div class="help-block with-errors"></div>
            ...
            <div class="col-md-6 nopadding-left">
                {!! Form::password('password_confirmation', [
                    'class' => 'form-control',
                    'placeholder' => trans('app.placeholder.confirm_password'),
                    'data-match' => '#password',
                    'required',
                ]) !!}
                <div class="help-block with-errors"></div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('dob', null, [
                    ...
                    'placeholder' => trans('app.placeholder.dob'),
                ]) !!}
            </div>
        </div>
    </div>
...
<div class="form-group">
    ...
    {!! Form::textarea('description', null, [
        ...
        'rows' => '2',
        'placeholder' => trans('app.placeholder.biography'),
    ]) !!}
</div>
...
<div class="form-group">
    ...
    @if (isset($user) && $user->avatarImage)
        <label>
            <img src="{{ get_avatar_src($user, 'small') }}" alt="{{ trans('app.avatar') }}">
    ...
    <div class="row">
        <div class="col-md-9 nopadding-right">
            <input id="uploadFile" placeholder="{{ trans('app.placeholder.avatar') }}" class="form-control"
