<div class="form-group">
  ...
  {!! Form::select('customer_id', isset($customer) ? [$customer->id => $customer->name] : [], isset($customer) ? $customer->id : null, ['class' => 'form-control searchCustomer', 'style' => 'width: 100%', 'required']) !!}
