  ...
  <div class="box">
    ...
    <div class="box-body responsive-table">
      <table class="table table-hover table-2nd-no-sort">
        <thead>
          <tr>
            @can('massDelete', \App\Models\Manufacturer::class)
        ...
        <tbody id="massSelectArea">
          @foreach ($manufacturers as $manufacturer)
            <tr>
              ...
              @endcan
              <td>
                <img src="{{ get_logo_url($manufacturer, 'tiny') }}" class="img-sm" alt="{{ trans('app.image') }}">
              </td>
              <td>
                <p class="indent10">
                  {{ $manufacturer->name }}
      ...
      <table class="table table-hover table-2nd-sort">
        ...
        <tbody>
          @foreach ($trashes as $trash)
            <tr>
              <td>
                <img src="{{ get_logo_url($trash, 'tiny') }}" class="img-circle img-sm" alt="{{ trans('app.image') }}">
                <p class="indent10">
                  {{ $trash->name }}
                </p>
              </td>
