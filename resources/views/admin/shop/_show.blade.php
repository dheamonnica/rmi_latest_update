  ...
  <div class="modal-content">
    <div class="modal-body" style="padding: 0px;">
      ...
      <div class="col-md-3 nopadding" style="margin-top: 10px;">
        <img src="{{ get_logo_url($shop, 'medium') }}" class="thumbnail" width="100%" alt="{{ trans('app.logo') }}">
      </div>
            ...
            <div class="box-body">
              <table class="table">
                <tr>
                  ...
                  <td style="width: 75%;">{{ get_formated_currency($shop->config->order_handling_cost, 2, config('system_settings.currency.id')) }}</td>
                </tr>
