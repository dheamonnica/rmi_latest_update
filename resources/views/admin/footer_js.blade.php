<script type="text/javascript">
    ...
    `;
        ...
        //     // Select the row with the class 'expanded-second-table'
        //     let rows = $('#target-tables-report-administrator tbody').find('tr.expanded-second-table');

        //     // Get the id of the clicked row
        //     let clickedRowId = $(this).attr('id');

        // //     // Extract the index from the id
        // //     let expandedSecondTableIndex = clickedRowId.split('-')
        // // .pop(); // Extracts the number after the last '-'

        //     // Now you can use the expandedSecondTableIndex
        //     console.log('Clicked Row Index:', clickedRowId);

        //     // Perform any additional operations using expandedSecondTableIndex

        //     // Get the DataTable row index
        //     let rowIndex = tableTargetsReportAdministrator.row(rows).index();

        //     console.log(rowIndex, 'rowIndex second');

        //     // Get the data from the DataTable for this row
        //     let rowDatas = tableTargetsReportAdministrator.row(rowIndex).data();

        //     // console.log(rowDatas, 'rowDatas second'); // Print the data to console or use as needed

        //     // Get the DataTable row index

        //     // Get the data from the DataTable for this row

        //     let tr = $(this).closest('tr'); // Get the clicked row
        //     let row = tableTargetsReportAdministrator.row(tr); // Get the DataTables row object
        ...
        //         // If the child row is already shown, hide it
        //         childRow.hide();
        //         tr.removeClass('shown');
        //     } else {
        //         // If the child row is not shown, show it
        //         if (!childRow.length) {

        //             // If the child row doesn't exist yet, create it
        //             let rowData = row.data(); // Get the row data from DataTables
        //             console.log(rowData, 'rowData'); // Log the data for debugging

        //             // Create the content for the child row
        //             let childRowContent = formatSecondLevel(rowDatas);
        //             // console.log(childRowContent, 'childRowContent'); // Log the generated HTML for debugging

        //             // Insert the child row after the current row
        //             tr.after('<tr class="child"><td colspan="8">' + childRowContent + '</td></tr>');
        //             childRow = tr.next('tr.child'); // Update reference to the newly created child row
        //     // console.log(tr.before('tr.child'), 'childRow');

        //         }
        //         childRow.show(); // Show the child row
        //         tr.addClass('shown');
        //     }
        // });
