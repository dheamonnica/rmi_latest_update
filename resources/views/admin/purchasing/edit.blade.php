...
{!! Form::open(['route' => ['admin.purchasing.purchasing.updateManufacture'], 'files' => true,'method' => 'post', 'class' => 'form', 'id' => 'purchaseForm']) !!}
...
<div class="row">
	...
	<div class="col-md-12">
		<h3 class="box-title">
			{{ trans('app.update_request_purchasing') }}
		</h3>
	</div>
    <div class="col-md-8">
		<div class="box">
			  ...
			  <div class="row">
				<div class="col-sm-12">
				  <div class="well well-lg">
					<span class="lead">
					  {{ trans('app.form.purchasing_date') . ': '. $data->created_at}}
					</span>
			  ...
			  <div class="row">
				<div class="col-md-12">
				  ...
				  <div class="col-md-8 nopadding input-lg">
					{!! Form::select('manufacture', $manufacture, $manufacture_id, ['class' => 'form-control select2', 'placeholder' => trans('app.placeholder.choose_manufacture')]) !!}
				  </div>
