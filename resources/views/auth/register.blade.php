      ...
      <div class="form-container">
        ...
        <div class="login-form-section">
          ...
          <div class="form-section">
            <h3 class="text-center mt-0">{{ trans('app.form.register') }} Vendor</h3>
            ...
            @if (is_subscription_enabled())
              <div class="form-group has-feedback">
                {{ Form::select('plan', $plans, isset($plan) ? $plan->id : null, ['id' => 'plans', 'class' => 'form-control input-lg', 'required']) }}
